...
class ArduinoCommunication:
    def __init__(self, port='COM6', baudrate=115200, data_filename='sensor_data.txt'):
...
class SensorDataPlot:
    ...
    def __init__(self, maxlen=1000):
        ...
        self.line, = self.ax.plot([], [], lw=2, label='Potentiometer')

    def handle_data(self, data):
        sensor_value = data.get('sensor1')
        print("sensor_value type = ", type(sensor_value))
    ...
    def plot(self):
        ...
        self.ax.set_title('Potentiometer Data')
        self.ax.set_xlabel('Measurements')
        self.ax.set_ylabel('Potentiometer Value')
